...
const perguntas = [
    ...
    {
        enunciado: "Com o entusiasmo de Gabriel, sua professora de tecnologia decidiu organizar uma série de aulas sobre IA. No final de uma dessas aulas, ela pediu aos alunos que escrevessem um trabalho sobre o uso da IA na Conservação Ambiental. Gabriel ponderou suas opções e tomou uma decisão:",
        alternativas: [
            {
    ...
    },
    {
        ...
        alternativas: [
            {
                texto: "Ele defendeu a ideia de que a IA poderia criar novas oportunidades de emprego e melhorar as habilidades humanas, especialmente na área de IA na Conservação Ambiental.",
                afirmacao: "o que ajudou muito em suas pesquisas sobre IA na Conservação Ambiental. "
            },
            {
                texto: "Ele expressou sua preocupação com as pessoas que poderiam perder seus empregos para as máquinas, enfatizando a importância de proteger os trabalhadores, inclusive aqueles que trabalham na IA na Conservação Ambiental.",
                afirmacao: "o que ajudou muito em suas pesquisas sobre IA na Conservação Ambiental. "
            }
        ]
    },
    {
        enunciado: "No final da discussão, a tarefa era criar uma imagem no computador que representasse suas opiniões sobre o uso da IA na Conservação Ambiental. Gabriel escolheu:",
        alternativas: [
            {
